...
// 3D rendering options (Depth test, cull face)
...
//gl.depthFunc(gl.GREATER); obdrzi tiste z vecjo globino
gl.depthFunc(gl.LESS);

// ======= CULL FACE =======
// For efficiency, enable back face culling.
// Izlocanje ploskev, ki se skrivajo
...
function render() {
    ...
    // MVP matrix (projection * view * model) * vector4
