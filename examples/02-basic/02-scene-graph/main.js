...
const root = new Node();
root.localMatrix = mat4.create(); // identitiy

// The camera holds a projection transformation, and its global
// transformation is used as the inverse view transformation.
const camera = new Node();
camera.localMatrix = mat4.create(); // View matrix
camera.projectionMatrix = mat4.create(); // Projection matrix
...
function render() {
    ...
    mat4.fromTranslation(camera.localMatrix, [ 0, 0, 5 ]); // push 5 units
